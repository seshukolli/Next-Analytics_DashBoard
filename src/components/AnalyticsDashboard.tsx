...
const AnalyticsDashboard= ({avgVisitorsPerDay,amtVisitorsPerToday,timeseriesPageviews,topCountries}: AnalyticsDashboardProps) => {
    return (
    <div className="flex flex-col gap-6">
        <div className="grid w-full mx-auto grid-cols-1
        sm:grid-cols-2 gap-6">
            <Card className="w-full mx-auto max-w-xs">
                <p className="text-tremor-default text-dark-tremor-content">Avg. visitors/day
                <Badge percentage={parseFloat(avgVisitorsPerDay)} />
                </p>
                <p className="text-3x1 text-dark-tremor-content-strong font-semibond">
                    {avgVisitorsPerDay}
                </p>
            </Card>
            <Card className="w-full mx-auto max-w-xs">
                <p className="flex gap-2.5 items.center text-tremor-default text-dark-tremor-content">Visitors today 
                <Badge percentage={(amtVisitorsPerToday/Number(avgVisitorsPerDay)-1)*100
                }/>
                </p>
                <p className="text-3x1 text-dark-tremor-content-strong font-semibond">
                    {amtVisitorsPerToday}
